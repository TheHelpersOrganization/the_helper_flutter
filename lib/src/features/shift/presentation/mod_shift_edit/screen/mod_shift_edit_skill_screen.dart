...
class ModShiftEditSkillScreen extends ConsumerWidget {
  final int activityId;
  final int shiftId;

  const ModShiftEditSkillScreen({
    super.key,
