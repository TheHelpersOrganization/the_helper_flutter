...
class ProfileContactEditView extends ConsumerStatefulWidget {
  final Contact initialData;

  const ProfileContactEditView({
    super.key,
    required this.initialData,
  });

  @override
  ConsumerState<ProfileContactEditView> createState() =>
      _ProfileContactEditViewState();
}

class _ProfileContactEditViewState
    extends ConsumerState<ProfileContactEditView> {
  ...
  late PhoneController phoneController = PhoneController(
      widget.initialData.phoneNumber != null
          ? PhoneNumber.parse(widget.initialData.phoneNumber!)
          : null);
