...
class ActivityFilterSkill extends ConsumerStatefulWidget {
  const ActivityFilterSkill({super.key});

  @override
  ConsumerState<ActivityFilterSkill> createState() =>
      _ActivityFilterSkillState();
}

class _ActivityFilterSkillState extends ConsumerState<ActivityFilterSkill> {
