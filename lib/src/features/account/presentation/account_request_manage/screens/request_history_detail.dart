...
class RequestHistoryDetail extends ConsumerWidget {
  final AccountRequestModel requestData;

  const RequestHistoryDetail({super.key, required this.requestData});
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: PrimaryButton(
                          ...
                          onPressed: () async {
                            await ref
                                .watch(verifiedAccountControllerProvider
                                    .notifier)
                                .verifyAccount(accountId: requestData.accountId!);
                            if (context.mounted) {
                              context.pop();
                            }
                          },
